...
function index(_ref) {
  ...
  }, __jsx(react_page_scroller__WEBPACK_IMPORTED_MODULE_7__.default, {
...
/***/ "./node_modules/react-page-scroller/es/Events.js":
/*!*******************************************************!*\
  !*** ./node_modules/react-page-scroller/es/Events.js ***!
  \*******************************************************/
...
/* harmony import */ var _Events__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Events */ "./node_modules/react-page-scroller/es/Events.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils */ "./node_modules/react-page-scroller/es/utils.js");
/* harmony import */ var _usePrevValue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./usePrevValue */ "./node_modules/react-page-scroller/es/usePrevValue.js");
...
var ReactPageScroller = function ReactPageScroller(_ref) {
  ...
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(DEFAULT_COMPONENT_INDEX),
      componentIndex = _useState[0],
      setComponentIndex = _useState[1];

  var _useState2 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(DEFAULT_COMPONENTS_TO_RENDER_LENGTH),
      componentsToRenderLength = _useState2[0],
      setComponentsToRenderLength = _useState2[1];

  var prevComponentIndex = (0,_usePrevValue__WEBPACK_IMPORTED_MODULE_4__.default)(componentIndex);
  var scrollContainer = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  var pageContainer = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  var lastScrolledElement = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  children = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(function () {
    return react__WEBPACK_IMPORTED_MODULE_0___default().Children.toArray(children);
  }, [children]);
  var scrollPage = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function (nextComponentIndex) {
  ...
  var addNextComponent = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function (componentsToRenderOnMountLength) {
    var tempComponentsToRenderLength = 0;

    if (!(0,_utils__WEBPACK_IMPORTED_MODULE_3__.isNil)(componentsToRenderOnMountLength)) {
    ...
    if (tempComponentsToRenderLength <= componentIndex + 1) {
      if (!(0,_utils__WEBPACK_IMPORTED_MODULE_3__.isNil)(children[componentIndex + 1])) {
  ...
  var checkRenderOnMount = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () {
    if (renderAllPagesOnFirstRender) {
      setComponentsToRenderLength(react__WEBPACK_IMPORTED_MODULE_0___default().Children.count(children));
    } else if (!(0,_utils__WEBPACK_IMPORTED_MODULE_3__.isNil)(children[DEFAULT_COMPONENT_INDEX + 1])) {
      addNextComponent(DEFAULT_COMPONENTS_TO_RENDER_LENGTH + 1);
    }
  }, [addNextComponent, children, renderAllPagesOnFirstRender]);
  var disableScroll = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () {
  ...
  var enableDocumentScroll = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () {
    if (!isBodyScrollEnabled) {
  ...
  var setRenderComponents = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () {
    var newComponentsToRender = [];
    var i = 0;

    while (i < componentsToRenderLength && !(0,_utils__WEBPACK_IMPORTED_MODULE_3__.isNil)(children[i])) {
      containers[i] = true;
      newComponentsToRender.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
        key: i,
        style: {
          height: "100%",
          width: "100%"
        }
      }, react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(children[i], _extends({}, children[i].props))));
      i++;
    }

    return newComponentsToRender;
  }, [children, componentsToRenderLength]);
  var scrollWindowDown = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () {
    if (!isScrolling && !blockScrollDown) {
      if (!(0,_utils__WEBPACK_IMPORTED_MODULE_3__.isNil)(containers[componentIndex + 1])) {
        disableScroll();
        isScrolling = true;
  ...
  var scrollWindowUp = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function () {
  ...
  var touchMove = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function (event) {
    if (!(0,_utils__WEBPACK_IMPORTED_MODULE_3__.isNull)(previousTouchMove)) {
  ...
  var wheelScroll = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function (event) {
    if (Math.abs(event.deltaY) > MINIMAL_DELTA_Y_DIFFERENCE) {
      if ((0,_utils__WEBPACK_IMPORTED_MODULE_3__.isPositiveNumber)(event.deltaY)) {
  ...
  var keyPress = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(function (event) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    scrollContainer.current.addEventListener(_Events__WEBPACK_IMPORTED_MODULE_2__.TOUCHMOVE, touchMove);
    scrollContainer.current.addEventListener(_Events__WEBPACK_IMPORTED_MODULE_2__.KEYDOWN, keyPress);
    return function () {
      scrollContainer.current.removeEventListener(_Events__WEBPACK_IMPORTED_MODULE_2__.TOUCHMOVE, touchMove);
      scrollContainer.current.removeEventListener(_Events__WEBPACK_IMPORTED_MODULE_2__.KEYDOWN, keyPress);
    };
  }, [touchMove, keyPress]);
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    isMounted = true;
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    if (!(0,_utils__WEBPACK_IMPORTED_MODULE_3__.isNil)(customPageNumber) && customPageNumber !== componentIndex) {
      var newComponentsToRenderLength = componentsToRenderLength;

      if (customPageNumber !== componentIndex) {
        if (!(0,_utils__WEBPACK_IMPORTED_MODULE_3__.isNil)(containers[customPageNumber]) && !isScrolling) {
          isScrolling = true; // eslint-disable-next-line max-len

          scrollPage(customPageNumber);

          if ((0,_utils__WEBPACK_IMPORTED_MODULE_3__.isNil)(containers[customPageNumber]) && !(0,_utils__WEBPACK_IMPORTED_MODULE_3__.isNil)(children[customPageNumber])) {
        ...
        } else if (!isScrolling && !(0,_utils__WEBPACK_IMPORTED_MODULE_3__.isNil)(children[customPageNumber])) {
          for (var i = componentsToRenderLength; i <= customPageNumber; i++) {
            newComponentsToRenderLength++;
          }

          if (!(0,_utils__WEBPACK_IMPORTED_MODULE_3__.isNil)(children[customPageNumber])) {
            newComponentsToRenderLength++;
          }
...
ReactPageScroller.propTypes =  true ? {
  animationTimer: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().number),
  animationTimerBuffer: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().number),
  blockScrollDown: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().bool),
  blockScrollUp: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().bool),
  children: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().any),
  containerHeight: prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_1___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_1___default().string)]),
  containerWidth: prop_types__WEBPACK_IMPORTED_MODULE_1___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_1___default().number), (prop_types__WEBPACK_IMPORTED_MODULE_1___default().string)]),
  customPageNumber: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().number),
  handleScrollUnavailable: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func),
  onBeforePageScroll: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func),
  pageOnChange: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().func),
  renderAllPagesOnFirstRender: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().bool),
  transitionTimingFunction: (prop_types__WEBPACK_IMPORTED_MODULE_1___default().string)
} : 0;
...
/***/ "./node_modules/react-page-scroller/es/usePrevValue.js":
/*!*************************************************************!*\
  !*** ./node_modules/react-page-scroller/es/usePrevValue.js ***!
  \*************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/react-page-scroller/es/utils.js":
/*!******************************************************!*\
  !*** ./node_modules/react-page-scroller/es/utils.js ***!
  \******************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
