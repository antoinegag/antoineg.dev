  ...
  return (
    <div
      className={classNames(
        "min-h-screen flex flex-col justify-between px-5 bg-gradient-to-tl to-green-50 from-peach-50 via-green-50",
        className
      )}
    >
      <div className="w-full text-center my-auto">
        ...
        <p className="text-green-900 font-semibold text-xl xl:w-1/2 md:w-2/3 m-auto mb-10">
          I've been fortunate to find great companies with great people along my
          path to help people with software. Here they are.
        </p>
        <div className="mb-10">
